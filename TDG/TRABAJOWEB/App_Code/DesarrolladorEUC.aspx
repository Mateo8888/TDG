<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DesarrolladorEUC.aspx.cs" Inherits="TRABAJOWEB.DesarrolladorEUC" %>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    <!-- Encabezado amarillo -->
    <div class="header-euc p-4 mb-4">
        <div class="d-flex flex-wrap align-items-center gap-3">
            <div>
                <h3 class="mb-1">EUC – Crear / Gestionar</h3>
                <div class="muted">Crea EUCs, añade su Plan de automatización (si la criticidad es <b>ALTA</b>) y Documentación. Todo en una sola página.</div>
            </div>
            <div class="ms-auto">
                <button id="btnAgregarEuc" type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#mdlEuc">
                    + Agregar EUC
                </button>
            </div>
        </div>
